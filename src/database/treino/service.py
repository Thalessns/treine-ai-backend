...
class TreinoService:
    ...
    async def selecionar_treinos_usuario(self, dados: SelecionarUsuario) -> List[Treino]:
        select_query = select(treino_table).where(treino_table.usuario==str(dados.usuario))
